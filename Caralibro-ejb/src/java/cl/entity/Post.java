...
public class Post implements Serializable {
    ...
    @NotNull
    @Column(name = "ID_POST")
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "MYNOTIFSEQ_POST")
    @SequenceGenerator(name="MYNOTIFSEQ_POST", sequenceName = "SEQ_POST", allocationSize = 1)
